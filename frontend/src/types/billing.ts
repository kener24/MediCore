...
export interface InvoiceItem { id: number; invoice: number; item_type: InvoiceItemType; service: number | null; service_name?: string; inventory_item?: number | null; inventory_item_name?: string; inventory_lot?: number | null; inventory_lot_number?: string; related_consultation?: number | null; related_consumption?: number | null; source_type?: string | null; source_id?: string | null; description: string; quantity: string; unit_price: string; discount_amount: string; discount?: string; tax_type?: "taxed_15" | "taxed_18" | "exempt" | "exonerated"; tax_rate: string; subtotal?: string; tax_amount: string; total?: string; line_total: string; active: boolean; }
export interface Payment { id: number; clinic: number; invoice: number; invoice_number?: string; patient: number; patient_nombre?: string; cash_session: number | null; payment_number: string; payment_date: string; amount: string; method: PaymentMethod; reference: string; notes: string; status: PaymentStatus; received_by_nombre?: string; balance_before?: string; balance_after?: string; active: boolean; }
export interface CreditNote { id: number; clinic: number; clinic_nombre?: string; original_invoice: number; original_invoice_number?: string; original_invoice_fiscal_number?: string; patient?: number; patient_nombre?: string; credit_note_number: string; fiscal_number: string; cai: string; fiscal_range_start: string; fiscal_range_end: string; fiscal_expiration_date: string; issue_date: string; issue_datetime: string; reason: string; subtotal: string; discount_amount: string; tax_amount: string; total_amount: string; status: "issued" | "cancelled" | "voided"; issued_by?: number | null; issued_by_nombre?: string; active: boolean; }
export interface Invoice { id: number; clinic: number; patient: number; patient_nombre?: string; patient_identidad?: string; appointment: number | null; consultation: number | null; invoice_number: string; issue_date: string; due_date: string | null; status: InvoiceStatus; is_fiscal: boolean; fiscal_status: FiscalStatus; fiscal_number?: string | null; cai?: string; fiscal_expiration_date?: string | null; fiscal_range_start?: string; fiscal_range_end?: string; emitter_rtn?: string; emitter_legal_name?: string; customer_name?: string; customer_rtn?: string; subtotal: string; discount_amount: string; tax_amount: string; total_amount: string; subtotal_exempt?: string; subtotal_exonerated?: string; subtotal_taxed_15?: string; subtotal_taxed_18?: string; isv_15?: string; isv_18?: string; paid_amount: string; balance_due: string; amount_in_words?: string; notes?: string; active: boolean; related_credit_note?: CreditNote | null; items?: InvoiceItem[]; payments?: Payment[]; success?: boolean; message?: string; payment_warning?: string; invoice_id?: number; credit_note_id?: number; credit_note_number?: string; }
export interface CashMovement { id: number; clinic: number; cash_session: number; movement_type: "apertura" | "pago" | "ingreso" | "egreso" | "reverso" | "ajuste" | "cierre"; payment?: number | null; invoice?: number | null; method?: PaymentMethod | ""; reference?: string; amount: string; reason: string; notes: string; active: boolean; }
export interface CashSession { id: number; clinic: number; opened_by: number; opened_by_nombre?: string; opening_datetime: string; closing_datetime: string | null; opening_amount: string; closing_amount: string | null; expected_amount: string; expected_amount_live?: string; difference_amount: string; cash_total?: string; income_total?: string; expense_total?: string; payments_count?: number; movements_count?: number; payment_method_totals?: Record<string, string>; status: CashStatus; notes: string; active: boolean; movements?: CashMovement[]; }
export interface CashSummary { date: string; open_sessions: number; closed_sessions: number; opening_total: string; closing_total: string; difference_total: string; cash_payments: string; card_payments: string; transfer_payments: string; other_payments: string; manual_income: string; manual_expense: string; }
...
export interface FiscalReadiness { ready: boolean; status: string; missing_fields: string[]; message: string; active_range: FiscalDocumentRange | null; }
