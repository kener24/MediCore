...
urlpatterns = [
    ...
    path("api/reception/visits/<int:pk>/send-to-triage/", PatientVisitViewSet.as_view({"patch": "send_to_triage", "post": "send_to_triage"}), name="reception-send-to-triage"),
    path("api/reception/visits/<int:pk>/send-to-doctor/", PatientVisitViewSet.as_view({"patch": "send_to_doctor", "post": "send_to_doctor"}), name="reception-send-to-doctor"),
    path("api/reception/visits/<int:pk>/cancel/", PatientVisitViewSet.as_view({"patch": "cancel_visit", "post": "cancel_visit"}), name="reception-cancel-visit"),
    ...
    path("api/patient-portal/discharge-summaries/", PatientPortalDischargeSummariesView.as_view(), name="patient-portal-discharge-summaries"),
    path("api/patient-portal/discharge-summaries/<int:summary_id>/", PatientPortalDischargeSummariesView.as_view(), name="patient-portal-discharge-summary-detail"),
    ...
    path("api/patient-portal/prescriptions/<int:prescription_id>/pdf/", PatientPortalPrescriptionPdfView.as_view(), name="patient-portal-prescription-pdf"),
    ...
    path("api/patient-portal/invoices/<int:invoice_id>/pdf/", PatientPortalInvoicePdfView.as_view(), name="patient-portal-invoice-pdf"),
    ...
    path("api/patient-portal/credit-notes/", PatientPortalCreditNotesView.as_view(), name="patient-portal-credit-notes"),
    path("api/patient-portal/credit-notes/<int:credit_note_id>/", PatientPortalCreditNotesView.as_view(), name="patient-portal-credit-note-detail"),
    ...
    path("api/patient-portal/payments/<int:payment_id>/receipt-pdf/", PatientPortalPaymentReceiptView.as_view(), name="patient-portal-payment-receipt"),
    path("api/patient-portal/payments/<int:payment_id>/receipt/", PatientPortalPaymentReceiptView.as_view(), name="patient-portal-payment-receipt-canonical"),
    ...
    path("api/patient-portal/notifications/<int:notification_id>/mark-read/", PatientPortalNotificationMarkReadView.as_view(), name="patient-portal-notification-mark-read"),
    path("api/patient-portal/notifications/mark-all-read/", PatientPortalNotificationsMarkAllReadView.as_view(), name="patient-portal-notifications-mark-all-read"),
    path("api/patient-portal/devices/", PushDeviceView.as_view(), name="patient-portal-devices"),
    path("api/patient-portal/devices/<int:device_id>/", PushDeviceView.as_view(), name="patient-portal-device-detail"),
    path("api/patient-portal/clinic-info/", PatientPortalClinicInfoView.as_view(), name="patient-portal-clinic-info"),
    path("api/patient-portal/settings/", PatientPortalSettingsView.as_view(), name="patient-portal-settings"),
    ...
    path("api/notifications/push-devices/<int:device_id>/", PushDeviceView.as_view(), name="notification-push-device-detail"),
